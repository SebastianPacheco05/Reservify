    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve([
          {
            id: "1",
            url: "../../public/foto-terraza-ok.jpeg",
            alt: "Vista principal del restaurante",
            isPrimary: true,
          },
          {
            id: "2",
            url: "../../public/terraza-2.webp",
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({
          ...
          address: "Calle Gran Vía 123, caribe, Colombia",
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({
          ...
          address: "Calle Gran Vía 123, 28013 Caribe, Colombia",
          coordinates: {
            lat: 40.4168,
            lng: -3.7038,
          },
