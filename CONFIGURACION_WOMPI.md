...
Abre tu navegador en: http://10.5.213.111:1106/docs

Deberías ver la documentación de la API (Swagger UI)

### 3. Probar el Endpoint de Clave Pública

En tu navegador, ve a: http://10.5.213.111:1106/wompi/public-key
...
4. Verifica en http://10.5.213.111:1106/wompi/public-key
...
- [ ] Backend está corriendo (http://10.5.213.111:1106/docs funciona)
...
- [ ] http://10.5.213.111:1106/wompi/public-key devuelve la clave
